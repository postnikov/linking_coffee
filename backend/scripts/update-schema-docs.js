 ...
 * 
 * Usage: node backend/scripts/update-schema-docs.js
 */
...
async function main() {
    try {
        console.log('🚀 Starting schema documentation update...\n');

        // Fetch schema
        const tables = await fetchBaseSchema();
        console.log(`✅ Fetched schema for ${tables.length} table(s)\n`);
        ...
        console.log(`✅ Schema documentation updated: ${outputPath}\n`);
        console.log('📊 Summary:');
